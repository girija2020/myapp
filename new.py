...
def test():
    ...
    if num_anom[0] > 10 and num_anom[0] < 25:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[0]) + ", it may not be something worrying" + string)
    if num_anom[0] > 20 and num_anom[0] < 45:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[0]) + ", there might be something you ight want to check out" + string)
    if num_anom[0] > 45 and num_anom[0] < 65:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[0]) + ", it would be wise to check your farm once" + string)
    if num_anom[0] > 65 and num_anom[0] < 85:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[0]) + ", something is up in the farm, please check it" + string)
    if num_anom[0] > 85 and num_anom[0] < 105:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[0]) + ", visit your farm to make sure nothing is wrong" + string)

    if num_anom[1] > 10 and num_anom[1] < 25:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[1]) + ", it may not be something worrying" + string)
    if num_anom[1] > 20 and num_anom[1] < 45:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[1]) + ", there might be something you ight want to check out" + string)
    if num_anom[1] > 45 and num_anom[1] < 65:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[1]) + ", it would be wise to check your farm once" + string)
    if num_anom[1] > 65 and num_anom[1] < 85:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[1]) + ", something is up in the farm, please check it" + string)
    if num_anom[1] > 85 and num_anom[1] < 105:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[1]) + ", visit your farm to make sure nothing is wrong" + string)

    if num_anom[2] > 10 and num_anom[2] < 25:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[2]) + ", it may not be something worrying" + string)
    if num_anom[2] > 20 and num_anom[2] < 45:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[2]) + ", there might be something you ight want to check out" + string)
    if num_anom[2] > 45 and num_anom[2] < 65:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[2]) + ", it would be wise to check your farm once" + string)
    if num_anom[2] > 65 and num_anom[2] < 85:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[2]) + ", something is up in the farm, please check it" + string)
    if num_anom[2] > 85 and num_anom[2] < 105:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[2]) + ", visit your farm to make sure nothing is wrong" + string)
    
    if num_anom[3] > 10 and num_anom[3] < 25:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[3]) + ", it may not be something worrying" + string)
    if num_anom[3] > 20 and num_anom[3] < 45:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[3]) + ", there might be something you ight want to check out" + string)
    if num_anom[3] > 45 and num_anom[3] < 65:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[3]) + ", it would be wise to check your farm once" + string)
    if num_anom[3] > 65 and num_anom[3] < 85:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[3]) + ", something is up in the farm, please check it" + string)
    if num_anom[3] > 85 and num_anom[3] < 105:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[3]) + ", visit your farm to make sure nothing is wrong" + string)
    
    if num_anom[4] > 10 and num_anom[4] < 25:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[4]) + ", it may not be something worrying" + string)
    if num_anom[4] > 20 and num_anom[4] < 45:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[4]) + ", there might be something you ight want to check out" + string)
    if num_anom[4] > 45 and num_anom[4] < 65:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[4]) + ", it would be wise to check your farm once" + string)
    if num_anom[4] > 65 and num_anom[4] < 85:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[4]) + ", something is up in the farm, please check it" + string)
    if num_anom[4] > 85 and num_anom[4] < 105:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[4]) + ", visit your farm to make sure nothing is wrong" + string)
    
    if num_anom[5] > 10 and num_anom[5] < 25:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[5]) + ", it may not be something worrying" + string)
    if num_anom[5] > 20 and num_anom[5] < 45:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[5]) + ", there might be something you ight want to check out" + string)
    if num_anom[5] > 45 and num_anom[5] < 65:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[5]) + ", it would be wise to check your farm once" + string)
    if num_anom[5] > 65 and num_anom[5] < 85:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[5]) + ", something is up in the farm, please check it" + string)
    if num_anom[5] > 85 and num_anom[5] < 105:
        sendEmail("dlgirija9@gmail.com","Anomaly detected","Hi there! An anomaly was detected from the data with probability " + str(num_anom[5]) + ", visit your farm to make sure nothing is wrong" + string)
